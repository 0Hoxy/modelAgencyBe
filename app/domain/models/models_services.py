...
class ModelsServices:
    ...
    async def get_domestic_model_by_info(self, model_info: ReadRevisitedModel) -> str | Optional[ReadDomesticModel]:
    ...
    async def update_model(self, update_data: UpdateDomesticModel | UpdateGlobalModel) -> ModelResponse:
        """국내 모델 정보 수정"""
        async with db.transaction() as conn:
